...
def generate_launch_description():
    ...
    # The infra streams are mono8 and the network takes rgb8.
    ...
    segformer_decoder_node = ComposableNode(
        ...
        parameters=[{
            ...
            # PeopleSemSegFormer emits 1x1x512x512; the NHWC default would read
            # that as 512 channels and drop every frame.
            'data_format': 'NCHW',
