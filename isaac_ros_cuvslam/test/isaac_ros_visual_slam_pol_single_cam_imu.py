...
_TEST_CASE_NAMESPACE = '/visual_slam_test_pol_single_cam'
...
def generate_test_description():
    ...
    cameras = ['front']
    return run_cuvslam_from_bag(_TEST_CASE_NAMESPACE, bag_path, cameras=cameras)


class IsaacRosVisualSlamServiceTest(IsaacROSBaseTest):
    """Checks that vslam produces odometry with a single camera."""

    def test_single_cam_pol(self):
